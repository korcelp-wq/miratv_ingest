...
--
-- Database: `xpdgxfsp_inhibitor_govenor_matrix`
--

-- --------------------------------------------------------

--
-- Table structure for table `igm_attestations`
--

CREATE TABLE `igm_attestations` (
  `id` bigint(20) NOT NULL,
  `attested_ts` datetime(6) NOT NULL,
  `rule_id` varchar(64) NOT NULL,
  `rule_scope` varchar(64) DEFAULT NULL,
  `rule_state` varchar(32) DEFAULT NULL,
  `rule_effect` varchar(64) DEFAULT NULL,
...
(1, 982144, 'system', 1.00, NULL, '2026-01-20 20:56:08', 1, 'deterministic_rule_match');
...
(1, 'content_ingestion_pipeline', 'introduce tightly coupled parsing logic into ingestion worker', 'blocked', 'Action was blocked to preserve modularity and prevent downstream coupling across ingestion, normalization, and delivery layers.', 'human', '2026-01-20 20:45:30'),
(2, 'backend_api', 'add endpoint without auth', 'blocked', 'All external endpoints must enforce authentication and rate limiting.', 'human', '2026-01-20 21:32:24'),
(3, 'backend_api', 'add endpoint without auth', 'blocked', 'All external endpoints must enforce authentication and rate limiting.', 'human', '2026-01-20 21:32:42');
...
--
-- Indexes for table `igm_attestations`
--
ALTER TABLE `igm_attestations`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `igm_attestations`
--
ALTER TABLE `igm_attestations`
...
--
ALTER TABLE `igm_governance_examples`
  MODIFY `example_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
