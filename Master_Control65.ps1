...
function Show-LiveErrorLog {
    ...
    while ($true) {
        ...
        Write-Host "Refresh  : every $RefreshSeconds seconds" -ForegroundColor DarkGray
        Write-Host "Return   : press Q" -ForegroundColor DarkGray
        Write-Host ""
        ...
        $sleepUntil = (Get-Date).AddSeconds($RefreshSeconds)
