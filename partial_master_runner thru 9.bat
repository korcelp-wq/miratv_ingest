...
REM ==================================================
 echo.
 echo [STEP 2.2] 2_2_raw_local_parse_trigger.ps1
 echo --------------------------------------------------
 powershell -NoProfile -ExecutionPolicy Bypass ^
  -File "%TRIGGERS%\2_2_raw_local_parse_trigger.ps1"
	if errorlevel 1 goto STOP
...
REM ==================================================
REM STEP 3 — ingest master trigger(LOCKED)
REM File: triggers\2ingest_master_trigger.ps1
REM Purpose: server-side normalize stage
REM ==================================================
echo.
echo [STEP 3] 2ingest_master_trigger.ps1
echo --------------------------------------------------
powershell -NoProfile -ExecutionPolicy Bypass ^
  -File "%TRIGGERS%\2ingest_master_trigger.ps1"
	if errorlevel 1 goto STOP
...
REM echo --------------------------------------------------
REM REM powershell -NoProfile -ExecutionPolicy Bypass -File "%TRIGGERS%\3.7_*.ps1"
REM REM if errorlevel 1 goto STOP
...
REM ==================================================
       echo.
       echo [STEP 4] 3ingest_trigger.bat
       echo 
REM --------------------------------------------------
      call "%TRIGGERS%\3ingest_trigger.bat"
       if errorlevel 1 goto STOP
       echo ✅ STEP 4 COMPLETE again (sorta)
