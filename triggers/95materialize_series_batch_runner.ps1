...
$BaseMaterializeUrl = "https://miratv.club/_workers/materialize_series2.php"
...
try {
    if ($SeriesId -le 0) {
        throw "SeriesId must be greater than 0"
    }

    $MATERIALIZE_URL = "{0}?token={1}&series_id={2}" -f $BaseMaterializeUrl, $Token, $SeriesId
