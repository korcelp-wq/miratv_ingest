...
echo ==================================================
REM Pass the series_id parameter to the worker
call "C:\miratv_ingest\series_details_worker.bat" %MIRATV_SERIES_ID%
...
REM ==================================================
REM STEP 9.5 — MATERIALIZE SERIES (NEW)
REM File: triggers\95materialize_series_trigger.ps1
REM Purpose: fill canonical series fields before finalize
REM ==================================================
echo.
echo [STEP 9.5] 9materialize_series_trigger.ps1
echo --------------------------------------------------
powershell -NoProfile -ExecutionPolicy Bypass ^
  -File "C:\miratv_ingest\triggers\9materialize_series_trigger.ps1" ^
  -SeriesId %MIRATV_SERIES_ID%
if errorlevel 1 goto STOP
echo ✅ STEP 9.5 COMPLETE

echo Waiting 5 seconds before finalize...
