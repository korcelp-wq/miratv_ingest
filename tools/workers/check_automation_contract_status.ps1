...
try {
    ...
    RequiredKillSwitch = "ENABLE_FRAME_CAPTURE_ARTWORK"
        ...
        @{
            Name = "plan_series_top_level_delta"
            Path = "tools\workers\plan_series_top_level_delta.ps1"
            Recurring = $false
            RequiredSignals = @("series_top_level_delta_plan_completed")
            RequiredKillSwitch = "ENABLE_SERIES_TOP_LEVEL_DELTA_PLAN"
        },
        @{
            Name = "preview_series_top_level_delta"
            Path = "tools\workers\preview_series_top_level_delta.ps1"
            Recurring = $false
            RequiredSignals = @("series_top_level_delta_preview_completed")
        ...
        @{
            Name = "apply_live_streams_delta_limited"
            Path = "tools\workers\apply_live_streams_delta_limited.ps1"
            Recurring = $false
            RequiredSignals = @("live_streams_delta_limited_apply_completed")
        ...
        @{
            Name = "apply_epg_retention"
            Path = "tools\workers\apply_epg_retention.ps1"
            Recurring = $false
            RequiredSignals = @("epg_retention_apply_completed")
            RequiredKillSwitch = "ENABLE_EPG_RETENTION_APPLY"
        },
        @{
        ...
        @{
            Name = "plan_vod_delta_preview_item_source_fix"
            Path = "tools\workers\plan_vod_delta_preview_item_source_fix.ps1"
            Recurring = $false
            RequiredSignals = @("vod_delta_preview_item_source_fix_planned_completed")
