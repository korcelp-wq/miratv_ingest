...
## Project Information
- **Project path**: c:\Android_Projects\MiraTV_project_PHASES_1_8
- **Working branch**: appmod/java-upgrade-20251209171647
...
- **Source JDK path (Java 17)**: C:\Program Files\Eclipse Adoptium\jdk-17.0.17.10-hotspot\bin
- **Target JDK path (Java 21)**: <span style="color:red"><to be installed, or specify the path here></span>
- **Build tool type**: Gradle Wrapper
- **Build tool path**: c:\Android_Projects\MiraTV_project_PHASES_1_8
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20251209171647`.
