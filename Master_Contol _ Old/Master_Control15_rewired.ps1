...
"@
        ...
        if ($declarative) {
            ...
            if ($declarative[0].PSObject.Properties.Name -contains 'confidence' -and $declarative[0].confidence) {
                $confidence = [double]$declarative[0].confidence
            } else {
                $confidence = 0.85
            }
        }
...
"@
        ...
        if ($aiMemory) {
            ...
            if ($aiMemory[0].PSObject.Properties.Name -contains 'confidence' -and $aiMemory[0].confidence) {
                $confidence = [double]$aiMemory[0].confidence
            } else {
                $confidence = 0.8
            }
        }
