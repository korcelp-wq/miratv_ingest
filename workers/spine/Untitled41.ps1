...
# Download/Replace the file with the fixed version
@'
#!/usr/bin/env pwsh
...
'@ | Out-File -FilePath MasterConsole.ps1 -Encoding utf8 -Force

Write-Host "✅ Master Console updated" -ForegroundColor Green