# MiraTV Series Index Worker (RAW INGEST - DIRECT STREAM)

$ErrorActionPreference = "Stop"

Write-Host "=============================="
Write-Host "MiraTV Series Index Worker"
Write-Host "=============================="
...
$RAW_DIR = "$ROOT\raw"
$OUTPUT = "$RAW_DIR\series.index.raw.json"

$URL = "http://uxurwymd.silvervpn.net:8080/player_api.php?username=Marina2025&password=3KY586YR&action=get_series"
...
Write-Host "Downloading series index (streaming)..."
