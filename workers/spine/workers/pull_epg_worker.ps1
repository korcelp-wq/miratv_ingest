# MiraTV EPG Index Worker (RAW INGEST - DIRECT STREAM)

$ErrorActionPreference = "Stop"

Write-Host "=============================="
Write-Host "MiraTV EPG Index Worker"
Write-Host "=============================="
...
$RAW_DIR = "$ROOT\raw"
$OUTPUT = "$RAW_DIR\epg.xml"

$URL = "http://uxurwymd.eldervpn.xyz:8080/xmltv.php?username=Marina2025&password=3KY586YR"
...
Write-Host "Downloading epg index (streaming)..."
...
Write-Host "EPG index captured successfully"
Write-Host "Bytes:"
Write-Host $bytes
